...
export default function Auth() {
  ...
  return (
    <div className="min-h-[100dvh] grid grid-cols-1 lg:grid-cols-[55fr_45fr] bg-background">
      {/* LEFT — form panel */}
      <div className="flex flex-col justify-start sm:justify-center px-4 sm:px-12 py-8 sm:py-12 bg-background relative">
        <div className="w-full sm:max-w-[400px] mx-auto px-2 sm:px-8 py-4 rounded-none sm:rounded-xl">
