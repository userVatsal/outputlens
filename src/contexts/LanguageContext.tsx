...
const translations: Record<Language, Record<string, string>> = {
  'en-US': {
    ...
    evaluateTrade: 'Run Risk Analysis',
    analyzing: 'Analyzing...',
    long: 'Long',
    short: 'Short',
    ...
    disclaimer: 'Risk analysis for informational purposes only. Not financial advice.',
    selectDate: 'Select trade date',
    color: 'Color',
    favorite: 'Favorite',
    analyze_trade: 'Run Analysis',
    riskInterpretation: 'Risk Interpretation',
    scenarioRegimes: 'Scenario Regimes',
    tailRisk: 'Tail Risk',
